...
* [Spring Data Reactive for Apache Cassandra](https://docs.spring.io/spring-boot/docs/2.5.2/reference/htmlsingle/#boot-features-cassandra)
...
* [Spring Data Reactive Couchbase](https://docs.spring.io/spring-boot/docs/2.5.2/reference/htmlsingle/#boot-features-couchbase)
...
* [Embedded LDAP Server](https://docs.spring.io/spring-boot/docs/2.5.2/reference/html/boot-features-nosql.html#boot-features-ldap-embedded)
