...
public class Swagger2Config {
    ...
    public Docket apiDocket(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                // .apis(RequestHandlerSelectors.withClassAnnotation(Api.class))                   // HelloController.java
                // .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class)) // HelloRestController.java
